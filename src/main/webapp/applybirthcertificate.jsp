...
<div class="field">
    ...
    <input type=" " id="childName" name="Child Name">
</div>

<div class="field">
   <label for="Father Name">Father Name: *</label>
   <input type=" " id="fatherName" name="Father Name">
</div>


<div class="field">
<label for="Mother Name">Mother Name: *</label>
<input type=" " id="motherName" name="Mother Name">
</div>


<div class="field">
<label for="Place Of Birth">Place Of Birth: *</label>
<input type=" " id="placeOfBirth" name="Place Of Birth">
</div>
...
<p><b>Permanent Address Of Parent: * </b></p>
...
<input type="text" id="zipCode" name="House no-locality-zip"><br>
</div>


<div class="field">
    <label for="Upload Addressproof">Upload Addressproof: *</label>
    <input type="file" id="Browse" id="addressProofLocation">
</div>
...
<script>
     ...
     $("#apply").click(function(e) {
        ...
        if (childName && fatherName && motherName && state && gender && dob && district && zipCode && placeOfBirth) {
            $.ajax({
                         type: 'POST',
                         url: '/csp/applybirthcertificate',
                         crossDomain: true,
                         ...
                         data: JSON.stringify({
                         status: 'PENDING',
                         addressProofLocation: '/test/proof.png',
                           childName,
                           fatherName,
                           motherName,
                           gender,
